...
public class Vista_MyFab extends JFrame {
	...
	public Vista_MyFab() {
		...
		lblNewLabel_1.setBounds(10, 0, 133, 164);
		contentPane.add(lblNewLabel_1);
		Image img = new ImageIcon(this.getClass().getResource("/myFabl.jpg")).getImage();
		lblNewLabel_1.setIcon(new ImageIcon(img));
		
		JLabel lblIntroduceElIdentificador_1 = new JLabel("Seleccione el identificador de socio:\r\n");
		...
		lblIntroduceElIdentificador_1.setBounds(203, 125, 262, 40);
		...
		buttonSalir.setBounds(784, 427, 130, 33);
		...
		scrollPane_1.setBounds(10, 267, 764, 193);
		contentPane.add(scrollPane_1);
		
		table_1 = new JTable();
		table_1.setGridColor(new Color(204, 204, 255));
		table_1.setBackground(new Color(255, 255, 255));
		table_1.setFont(new Font("Levenim MT", Font.PLAIN, 14));
		...
		btnLimpiar.setBounds(784, 372, 130, 33);
		contentPane.add(btnLimpiar);
		
		lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setBounds(670, 11, 244, 96);
		...
		comboBox.setFont(new Font("Levenim MT", Font.PLAIN, 13));
